  ...
  <body class="contact">
    ...
    <div class="team-container">
      ...
      <div class="team-member">
        <img src="img/arellano.jpg" alt="Arellano">
        <h3><strong>ARELLANO,</strong> Francis Miguel</h3>
        <p>Email: arellanofrancis321@gmail.com</p>
        <p>Contact: 0998 234 4600</p>
      </div>

      <div class="team-member">
        <img src="img/chan.jpg" alt="Chan">
        <h3><strong>CHAN,</strong> Justine Henry</h3>
        <p>Email: justinechan.05@gmail.com</p>
        <p>Contact: 0966 548 5388</p>
      </div>
